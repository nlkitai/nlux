    ...
    private highlightCurrentLine() {
        ...
        if (this.syntaxHighlighter && this.codeContainer && innerContent) {
            ...
            if (language) {
                ...
                // NO HTML SANITIZER — We do not apply HTML sanitization here as the content is generated by the
                // syntax highlighter, which is an extension that the developer provides. The developer is responsible
                // for ensuring that the syntax highlighter does not produce harmful content.
