...
This is the URL of the LangServe Runnable. You can read more about the exact format of the URL in [the reference documentation](/api/adapters/langchain-langserve#runnable-url).
