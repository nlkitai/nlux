            ...
            <div className="flex flex-col">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="start">
                                        {models.map((val, index) => (
                                            ...
                                            >
                                                <div
                                                    className="flex items-center gap-3 text-muted-foreground cursor-pointer z-auto">
                                                    <img
                                                        src={val.icon}
                                                        className="w-6 h-6 object-scale-down"
                                                    />
                ...
                <main className=" flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
                    <div className="flex flex-col gap-4">
                        <p>
                            How would you like to display the chat interface?<br/>
                            Choose from the following options:
                        </p>
                      <RadioGroup
                          className="flex gap-4"
                          value={mode}
                          onValueChange={(newValue) => setMode(newValue as 'drawer' | 'popover' | 'dialog')}
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="drawer" id="r2"/>
                          <Label htmlFor="r2" className="font-semibold cursor-pointer">Drawer</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="popover" id="r1"/>
                          <Label htmlFor="r1" className="font-semibold cursor-pointer">Popover</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="dialog" id="r3"/>
                          <Label htmlFor="r3" className="font-semibold cursor-pointer">Dialog</Label>
                        </div>
                      </RadioGroup>
                      <p>
                  ...
                  {mode === 'popover' && (
                      <Popover
                        ...
                        >
                            ...
                            <PopoverContent align="end" className="w-96 h-[60vh]">
                                {chatComponent}
                            </PopoverContent>
                        </Popover>
                    )}
