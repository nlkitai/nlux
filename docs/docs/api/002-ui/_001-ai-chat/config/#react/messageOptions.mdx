...
| --- | --- | --- | --- |
| `responseRenderer` | `ResponseRenderer<AiMsg>` | - | A custom renderer for AI responses. API documentation  for custom renderers can be found [here](/api/ui/custom-renderers). |
| `promptRenderer` | `PromptRenderer` | - | A custom renderer for user prompts. API documentation for custom renderers can be found [here](/api/ui/custom-renderers). |
