...
export class NluxRenderer<AiMsg> {
  ...
  mount() {
    ...
    try {
      ...
      rootComp = comp(CompChatRoom<AiMsg>)
        ...
        .withProps<CompChatRoomProps<AiMsg>>({
          ...
          initialConversationContent:
            this.theInitialConversationContent ?? undefined,
          ...
          showCodeBlockCopyButton:
            this.theMessageOptions?.showCodeBlockCopyButton,
          streamingAnimationSpeed:
            this.theMessageOptions?.streamingAnimationSpeed,
      ...
      if (CompExceptionsBoxConstructor) {
        ...
        warn(
          'Exception alert component is not registered! No exceptions will be shown.'
        );
      }
  ...
  unmount() {
    ...
    this.context.emit('preDestroy', {
      ...
      conversationHistory:
        this.chatRoom.getConversationContentForAdapter(
  ...
  public updateProps(props: UpdatableAiChatProps<AiMsg>) {
    ...
    if (props.hasOwnProperty('displayOptions')) {
      ...
      if (
        props.displayOptions?.colorScheme !== this.theDisplayOptions.colorScheme
      ) {
    ...
    if (props.hasOwnProperty('conversationOptions')) {
      ...
      if (
        props.conversationOptions?.layout !== this.theConversationOptions.layout
      ) {
        newConversationOptions.layout = props.conversationOptions?.layout;
        newProps.conversationLayout = getConversationLayout(
      ...
      if (
        ...
        this.theConversationOptions.autoScroll
      ) {
        newConversationOptions.autoScroll =
          props.conversationOptions?.autoScroll;
    ...
    if (props.hasOwnProperty('messageOptions')) {
      ...
      this.chatRoom?.setProps({
        streamingAnimationSpeed:
          props.messageOptions?.streamingAnimationSpeed ?? undefined,
        markdownLinkTarget:
          props.messageOptions?.markdownLinkTarget ?? undefined,
    ...
    if (props.hasOwnProperty('composerOptions')) {
      ...
      if (
        ...
        props.composerOptions.placeholder !==
          this.theComposerOptions.placeholder
      ) {
      ...
      if (
        ...
        props.composerOptions.disableSubmitButton !==
          this.theComposerOptions.disableSubmitButton
      ) {
        changedComposerOptions.disableSubmitButton =
          props.composerOptions.disableSubmitButton;
      }

      if (
        props.composerOptions?.hasOwnProperty('submitShortcut') &&
        props.composerOptions.submitShortcut !==
          this.theComposerOptions.submitShortcut
      ) {
        changedComposerOptions.submitShortcut =
          props.composerOptions.submitShortcut;
      }
    ...
    if (props.hasOwnProperty('personaOptions')) {
      ...
      if (props.personaOptions?.user !== this.thePersonasOptions?.user) {
        changedPersonaProps.userPersona =
          props.personaOptions?.user ?? undefined;
      }
